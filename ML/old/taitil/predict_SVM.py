...
svm_model = joblib.load('ML/taitil/Models/svm_model.pkl')
scaler = joblib.load('ML/taitil/Models/scaler.pkl')
label_encoder = joblib.load('ML/taitil/Models/label_encoder.pkl')
